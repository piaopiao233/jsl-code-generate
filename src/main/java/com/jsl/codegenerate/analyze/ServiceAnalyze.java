 ...
 */
public class ServiceAnalyze extends TLAnalyze {


    public ServiceAnalyze(Map<String, String> replaceVariable, Table table, GenerateConfig generateConfig, String tlPath) {
    ...
    public AnalyzeResult analyze() {
        ...
        analyzeResult.setFileName(entity + "Service.java");
        //输出文件路径
        analyzeResult.setOutPutPath(getOutPutPath() + "/service");
